  ...
  LoadingIndicatorAnimator(
      ...
      : pulseIconWidthAnimation = Tween(begin: 0.0, end: 32.0).animate(
        ...
        waveSize2Animation = Tween(begin: 15.0, end: 30.0).animate(
            CurvedAnimation(
                parent: reverseController,
                curve: const Interval(0.25, 0.45, curve: Curves.linear))),
        ...
        waveSize4Animation = Tween(begin: 15.0, end: 30.0).animate(
            CurvedAnimation(
                parent: reverseController,
                curve: const Interval(0.55, 0.75, curve: Curves.linear))),
        waveSize5Animation = Tween(begin: 15.0, end: 30.0).animate(
            CurvedAnimation(
                parent: reverseController,
                curve: const Interval(0.7, 0.9, curve: Curves.linear))),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
          ...
          child: GridView.count(
              ...
              children: [
                ...
                Container(
                    ...
                    child: AnimatedBuilder(
                        animation: repeatController,
                        builder: _buildThreeBounceWidget)),
                Container(
                    width: 200,
                    height: 200,
                    ...
                    child: AnimatedBuilder(
                        animation: repeatController,
                        builder: _buildWaveBounceWidget)),
                Container(
                    width: 200,
                    height: 200,
                    color: Colors.orange,
        ...
        const Text(
          "สำหรับเรียนรู้การใช้งาน reverse, repeat และ TweenSequence",
